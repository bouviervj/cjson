 ...
 */
#ifndef _CJSON_STD_STRING_FIELD_H_
#define _CJSON_STD_STRING_FIELD_H_
...
namespace field {
	...
	class std_string_field : public extended_field {

		public:

			std_string_field(const std::string& iName, cjson::dictionary* iDict) : extended_field(iName,iDict) {	
			}
			virtual ~std_string_field(){};		
		...
		ADD_FIELD_TYPE_FACTORY(cjson::field::std_string_field)	
